...
// router
//   .route("/profile/generateReports")
//   .get(checkJWT, (req,res,next)=>{
//     User.find({},(err,res)=>{
//       if(!err){
//         for(let i =0; i<res.length; i++){

//           if(res[i].isSeller==false){
//            console.log("User Name "+ res[i].email+ " Date User Joined: "+ res[i].created)
//           }
//         }
...
router.route("/generateReports").get(checkJWT,(req,res,next)=>{
  console.log("you are in the reports function")
})
